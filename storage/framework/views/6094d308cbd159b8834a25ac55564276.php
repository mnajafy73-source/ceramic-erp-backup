    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('inventory.raw')); ?>" class="btn btn-primary">مشاهده</a>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('inventory.mum')); ?>" class="btn btn-warning">مشاهده</a>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('inventory.glaze1300')); ?>" class="btn btn-danger">مشاهده</a>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('inventory.warehouse')); ?>" class="btn btn-success">مشاهده</a>
            </div>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\ceramic-erp-backup\resources\views/inventory/index.blade.php ENDPATH**/ ?>