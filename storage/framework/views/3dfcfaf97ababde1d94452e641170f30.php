    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="pt-3">
            ...
            <div class="submenu" id="submenu-warehouse">
                ...
                <a href="<?php echo e(route('inventory.index')); ?>"><i class="fas fa-chart-line"></i> موجودی لحظه‌ای</a>
            </div>
            ...
            <div class="submenu" id="submenu-purchases">
                <a href="<?php echo e(route('raw-material-purchases.index')); ?>"><i class="fas fa-shopping-basket"></i> خرید مواد</a>
                <a href="<?php echo e(route('packaging-purchases.index')); ?>"><i class="fas fa-shopping-basket"></i> خرید کارتن و لایه</a>
