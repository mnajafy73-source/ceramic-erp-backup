...
<div class="mb-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo e(route('raw-material-purchases.index')); ?>">خرید مواد</a></li>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form action="<?php echo e(route('raw-material-purchases.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('raw-material-purchases.index')); ?>" class="btn btn-secondary ms-2">انصراف</a>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\ceramic-erp-backup\resources\views/raw-material-purchases/create.blade.php ENDPATH**/ ?>