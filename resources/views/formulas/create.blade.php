...
@section('content')
<div class="mb-4">
    <h4 class="fw-bold mb-1">ثبت فرمول جدید</h4>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form action="{{ route('formulas.store') }}" method="POST" id="formula-form">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div id="items-container">
                    <div class="item-row row g-2 mb-2">
                        ...
                        <div class="col-md-5">
                            <input type="number" name="items[0][percentage]" placeholder="درصد" class="form-control" required step="0.01" min="0" max="100">
                        </div>
                        <div class="col-md-2">
