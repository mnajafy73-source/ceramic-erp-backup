...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="pt-3">
            ...
            <!-- ۴. مواد سازی -->
            <a href="{{ route('material-making.index') }}" class="nav-link {{ request()->routeIs('material-making.*') ? 'active' : '' }}">
            ...
            <!-- ۷. موجودی -->
            <button class="nav-link menu-title {{ request()->routeIs('inventory.*') ? 'active' : '' }}"
            ...
            <a href="{{ route('inventory-logs.index') }}" class="nav-link {{ request()->routeIs('inventory-logs.*') ? 'active' : '' }}">
                <i class="fas fa-history"></i> آخرین تغییرات
            </a>

            <!-- ۹. حسابداری -->
            <button class="nav-link menu-title {{ request()->routeIs('accounting.*') ? 'active' : '' }}"
            ...
            <div class="submenu" id="submenu-accounting">
                <a href="{{ route('accounting.index') }}"><i class="fas fa-money-bill-wave"></i> پرداخت‌ها</a>
                <a href="{{ route('accounting.debtors') }}"><i class="fas fa-exclamation-triangle"></i> بدهکاران</a>
            </div>
            ...
            <!-- ۱۲. وارد کردن -->
            <form method="POST" action="{{ route('import.from-path') }}" id="sidebarImportForm" class="m-0 p-0">
                @csrf
                <button type="submit" class="nav-link {{ request()->routeIs('import.*') ? 'active' : '' }}" id="sidebarImportBtn">
