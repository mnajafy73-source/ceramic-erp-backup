...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="pt-3">
            <a href="{{ route('dashboard') }}" class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}"><i class="fas fa-tachometer-alt"></i> داشبورد</a>
            <a href="{{ route('productions.index') }}" class="nav-link {{ request()->routeIs('productions.*') ? 'active' : '' }}"><i class="fas fa-industry"></i> تولید</a>
            ...
            <a href="{{ route('product-sales-stats.index') }}" class="nav-link {{ request()->routeIs('product-sales-stats.*') ? 'active' : '' }}"><i class="fas fa-chart-line"></i> آمار</a>
            <a href="{{ route('import.index') }}" class="nav-link {{ request()->routeIs('import.*') ? 'active' : '' }}"><i class="fas fa-upload"></i> وارد کردن</a>
            ...
            <div class="submenu" id="submenu-settings">
                ...
                <a href="{{ route('settings.manual-inventory') }}"><i class="fas fa-hand-edit"></i> تنظیم موجودی اول دوره</a>
            </div>
    ...
    <div class="main-content" id="mainContent">
        <div class="topbar">
            ...
            <div><span class="text-muted">{{ Auth::user()->name ?? 'کاربر' }}</span></div>
        </div>
        <div class="p-3 p-md-4">
            ...
            @if(session('undo_record'))
                <div class="alert-undo">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('undo.restore') }}" class="btn btn-sm btn-success"><i class="fas fa-undo me-1"></i> بازگرداندن</a>
                        <a href="{{ route('undo.discard') }}" class="btn btn-sm btn-danger"><i class="fas fa-times me-1"></i> لغو</a>
                    </div>
                </div>
            @endif
