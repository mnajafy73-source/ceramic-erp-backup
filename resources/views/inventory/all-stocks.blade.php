...
<style>
    ...
    .search-wrapper .input-group { max-width: 600px; }
    ...
    .locked-cell {
        ...
        color: #adb5bd; margin-right: 4px; vertical-align: middle;
    }
    ...
    .auto-badge {
        ...
        margin-right: 4px; vertical-align: middle; font-weight: 600;
    }
    .manual-badge {
        display: inline-flex; align-items: center; justify-content: center;
        padding: 2px 8px; border-radius: 4px; font-size: 10px;
    ...
    .edit-cell-product-name small { color: #6c757d; font-weight: normal; font-size: 12px; }
