            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="kiln_number" class="form-select @error('kiln_number') is-invalid @enderror" required>
                        ...
                        <option value="1" {{ old('kiln_number') == '1' ? 'selected' : '' }}>کوره ۱</option>
                        <option value="2" {{ old('kiln_number') == '2' ? 'selected' : '' }}>کوره ۲</option>
                        <option value="3" {{ old('kiln_number') == '3' ? 'selected' : '' }}>کوره ۳</option>
                        <option value="4" {{ old('kiln_number') == '4' ? 'selected' : '' }}>کوره ۴</option>
                        <option value="packaging" {{ old('kiln_number') == 'packaging' ? 'selected' : '' }}>بسته‌بندی</option>
                    </select>
                    @error('kiln_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-3">
                    ...
                    <select name="firing_type" class="form-select @error('firing_type') is-invalid @enderror" required>
                        ...
                        <option value="معمولی" {{ old('firing_type') == 'معمولی' ? 'selected' : '' }}>معمولی</option>
                        <option value="1300" {{ old('firing_type') == '1300' ? 'selected' : '' }}>۱۳۰۰</option>
                        <option value="لعابدار" {{ old('firing_type') == 'لعابدار' ? 'selected' : '' }}>لعابدار</option>
                        <option value="موم" {{ old('firing_type') == 'موم' ? 'selected' : '' }}>موم</option>
                    </select>
                    @error('firing_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="total_quantity" class="form-control @error('total_quantity') is-invalid @enderror"
                           value="{{ old('total_quantity') }}" step="1" min="0" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="main_quantity" class="form-control @error('main_quantity') is-invalid @enderror"
                           value="{{ old('main_quantity') }}" step="1" min="0" required>
                    @error('main_quantity')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="waste" class="form-control @error('waste') is-invalid @enderror"
                           value="{{ old('waste') }}" step="1" min="0" required>
                    @error('waste')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
