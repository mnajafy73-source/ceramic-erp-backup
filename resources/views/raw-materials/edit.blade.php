...
@section('content')
<div class="mb-4">
    <h4 class="fw-bold mb-1">ویرایش ماده اولیه</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="unit" class="form-select @error('unit') is-invalid @enderror" required>
                        ...
                        <option value="kg" {{ old('unit', $rawMaterial->unit) == 'kg' ? 'selected' : '' }}>کیلوگرم</option>
                        <option value="ton" {{ old('unit', $rawMaterial->unit) == 'ton' ? 'selected' : '' }}>تن</option>
                    </select>
