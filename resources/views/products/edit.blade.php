        ...
        <form action="{{ route('products.update', $product) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <small class="text-muted">کد کالا قابل تغییر نیست.</small>
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="cavities" class="form-control" value="{{ old('cavities', $product->cavities) }}" min="1">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">خوراک پخت کوره تونلی (تعداد در ساعت)</label>
                    <input type="number" name="tonneli_feed_rate" class="form-control" value="{{ old('tonneli_feed_rate', $product->tonneli_feed_rate) }}" min="0">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="per_box" class="form-control" value="{{ old('per_box', $product->per_box) }}" min="0">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="per_pack" class="form-control" value="{{ old('per_pack', $product->per_pack) }}" min="0">
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="layers_per_box" class="form-control" value="{{ old('layers_per_box', $product->layers_per_box) }}" min="0">
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="formula_id" class="form-select @error('formula_id') is-invalid @enderror">
                        ...
                        @foreach($formulas as $formula)
                            <option value="{{ $formula->id }}" {{ old('formula_id', $product->formula_id) == $formula->id ? 'selected' : '' }}>{{ $formula->name }}</option>
                        @endforeach
                    </select>
