            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="carton_packaging_id" class="form-select @error('carton_packaging_id') is-invalid @enderror">
                        ...
                        @foreach($packagings as $packaging)
                            <option value="{{ $packaging->id }}" {{ old('carton_packaging_id', $product->carton_packaging_id) == $packaging->id ? 'selected' : '' }}>
                                {{ $packaging->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <select name="layer_packaging_id" class="form-select @error('layer_packaging_id') is-invalid @enderror">
                        ...
                        @foreach($packagings as $packaging)
                            <option value="{{ $packaging->id }}" {{ old('layer_packaging_id', $product->layer_packaging_id) == $packaging->id ? 'selected' : '' }}>
                                {{ $packaging->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <select name="firing_process" class="form-select @error('firing_process') is-invalid @enderror">
                        <option value="tonneli" {{ old('firing_process', $product->firing_process) == 'tonneli' ? 'selected' : '' }}>تونلی</option>
                        <option value="shuttle" {{ old('firing_process', $product->firing_process) == 'shuttle' ? 'selected' : '' }}>شاتل</option>
                        <option value="both" {{ old('firing_process', $product->firing_process) == 'both' ? 'selected' : '' }}>هر دو</option>
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <select name="product_type" class="form-select @error('product_type') is-invalid @enderror">
                        <option value="normal" {{ old('product_type', $product->product_type ?? 'normal') == 'normal' ? 'selected' : '' }}>معمولی</option>
                        <option value="injection" {{ old('product_type', $product->product_type ?? '') == 'injection' ? 'selected' : '' }}>تزریق</option>
                    </select>
                    @error('product_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
