...
@section('content')
<div class="mb-4">
    <h4 class="fw-bold mb-1">ایجاد کالای جدید</h4>
        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="code" class="form-label">کد کالا <span class="text-danger">*</span></label>
                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" required maxlength="50">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="initial_stock" id="initial_stock" class="form-control @error('initial_stock') is-invalid @enderror" value="{{ old('initial_stock', 0) }}" min="0">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="kiln_type" id="kiln_type" class="form-select @error('kiln_type') is-invalid @enderror" required>
                        <option value="">انتخاب کنید...</option>
                        <option value="tonneli" {{ old('kiln_type') == 'tonneli' ? 'selected' : '' }}>تونلی</option>
                        <option value="shuttle" {{ old('kiln_type') == 'shuttle' ? 'selected' : '' }}>شاتل</option>
                        <option value="both" {{ old('kiln_type') == 'both' ? 'selected' : '' }}>هر دو</option>
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="firing_process" id="firing_process" class="form-select @error('firing_process') is-invalid @enderror" required>
                        <option value="">انتخاب کنید...</option>
                        <option value="standard" {{ old('firing_process') == 'standard' ? 'selected' : '' }}>پخت معمولی</option>
                        <option value="multistage" {{ old('firing_process') == 'multistage' ? 'selected' : '' }}>پخت چندمرحله‌ای</option>
                    </select>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="tonneli_feed_rate" id="tonneli_feed_rate" class="form-control @error('tonneli_feed_rate') is-invalid @enderror" value="{{ old('tonneli_feed_rate') }}" min="0">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="cavities" class="form-label">حفره</label>
                    <input type="number" name="cavities" id="cavities" class="form-control @error('cavities') is-invalid @enderror" value="{{ old('cavities', 1) }}" min="1">
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" name="per_box" id="per_box" class="form-control @error('per_box') is-invalid @enderror" value="{{ old('per_box') }}" min="0">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="per_pack" class="form-label">تعداد در بسته</label>
                    <input type="number" name="per_pack" id="per_pack" class="form-control @error('per_pack') is-invalid @enderror" value="{{ old('per_pack') }}" min="0">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="per_pallet" class="form-label">تعداد در پالت</label>
                    <input type="number" name="per_pallet" id="per_pallet" class="form-control @error('per_pallet') is-invalid @enderror" value="{{ old('per_pallet') }}" min="0">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="box_type" class="form-label">نوع کارتن</label>
                    <input type="text" name="box_type" id="box_type" class="form-control @error('box_type') is-invalid @enderror" value="{{ old('box_type') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="layers_per_box" id="layers_per_box" class="form-control @error('layers_per_box') is-invalid @enderror" value="{{ old('layers_per_box') }}" min="0">
                </div>
                <div class="col-md-6 mb-3">
                    <div class="form-check form-switch mt-4">
